...
hspike = infercnv:::.subcluster_tumors_general(hspike)

hspike.hmm = infercnv:::predict_CNV_via_HMM_on_tumor_subclusters(hspike, infercnv:::get_spike_dists(hspike), infercnv:::get_hspike_cnv_mean_sd_trend_by_num_cells_fit(hspike))
