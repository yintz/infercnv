...
If you want to use the interactive heatmap visualization, please also install the _R_ packages `r CRANpkg("tibble")`, `r Githubpkg("bmbroom/tsvio")` and `r Githubpkg("bmbroom/NGCHMR")`. To install optional packages, type the following in an R command window:
...
HMM preditions
```{r, echo=FALSE}
knitr::include_graphics("../example_output/infercnv.14_HMM_predHMMi6.hmm_mode-samples.repr_intensities.png")
```
