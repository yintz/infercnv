...
test_that("smooth_window works with one observation, window_length 5",{
    expect_equal(round(infercnv:::.smooth_window(data=matrix_one_long_2,
                                                 window_length=5,
                                                 smooth_ends=T),2),
                 smooth_answer_3)
})
test_that("smooth_window works with two observations, window_length 5",{
    expect_equal(round(infercnv:::.smooth_window(data=matrix_two_long_2,
                                                 window_length=5,
                                                 smooth_ends=T),2),
                 smooth_answer_4)
})
...
test_that("smooth_ends_helper works, tail length 3", {
    expect_equal(round(infercnv:::.smooth_ends_helper(obs_data=ends_data, tail_length=3),2),
...
test_that("smooth_ends_helper works, tail length 7", {
    expect_equal(round(infercnv:::.smooth_ends_helper(obs_data=ends_data, tail_length=7),2),
