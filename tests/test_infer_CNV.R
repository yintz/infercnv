...
avref_answer_2 <- matrix(c(c(0,5), rep(5,5)), ncol=2)
...
test_that("average_over_reference works with 3 observations, two reference",{
    expect_equal(average_over_reference(average_data=matrix_three,
                                        reference_observations=c(1,3)),
                 avref_answer_3)
          })
test_that("average_over_reference works with 5 observations, two reference",{
    expect_equal(average_over_reference(average_data=matrix_five,
                                        reference_observations=c(2,5)),
                 avref_answer_4)
          })
test_that("average_over_reference works with 1 observation, 1 reference",{
