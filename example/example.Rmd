...
plot_cnv(infercnv_obj2, output_filename='infercnv.non-DE-genes-masked', color_safe_pal = TRUE, x.range=c(low_threshold, high_threshold), x.center=1, title = "non-DE-genes-masked")
